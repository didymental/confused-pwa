    ...
    >
      ...
      <IonContent className="ion-padding">
        <IonText color="primary">
          <h1>Privacy Policy for Confused</h1>
        </IonText>

        <p>
          At Confused Session, accessible from https://confusedsession.vercel.app/, one of our main
          priorities is the privacy of our visitors. This Privacy Policy document contains types of
          information that is collected and recorded by Confused Session and how we use it.
        </p>
        ...
        <p>
          ...
          website with regards to the information that they shared and/or collect in Confused
          Session. This policy is not applicable to any information collected offline or via
        ...
        <p>
          Confused Session follows a standard procedure of using log files. These files log visitors
        ...
        <p>
          ...
          Beacons that are used in their respective advertisements and links that appear on Confused
          Session, which are sent directly to users&apos; browser. They automatically receive your
        ...
        <p>
          Note that Confused Session has no access to or control over these cookies that are used by
        ...
        <p>
          Confused Session&apos;s Privacy Policy does not apply to other advertisers or websites.
        ...
        <p>
          Confused Session does not knowingly collect any Personal Identifiable Information from
